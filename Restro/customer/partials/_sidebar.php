  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="../admin/assets/img/brand/logoblis_blue.png" class="navbar-brand-img" alt="..." style="max-width:8rem; max-height: 8rem;">
      </a>
      <!-- User -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="table.php">
              <i class="ni ni-cart text-primary"></i>Book Table
            </a>
          </li>
          <!-- <li class="nav-item">
