...
('10e0b6dc958adfb5b094d8935a13aeadbe783c25', 'System Admin', 'eke@gmail.com', '036d0ef7567a20b5a4ad24a354ea4a945ddab676');
...
CREATE TABLE `rposystem`. (`table_no` INT(11) NOT NULL AUTO_INCREMENT , `customer_name` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL , `date` DATE NOT NULL , `time` TIME NOT NULL , `no_of_persons` INT(11) NOT NULL , `budget` INT(11) NOT NULL , `table_status` TINYINT(1) NOT NULL , PRIMARY KEY (`table_no`)) ENGINE = InnoDB;
